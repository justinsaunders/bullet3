...
{
	PfxPerfCounter pc;
	PfxVector3 gravityAcceleration(0.0f,-9.8f,0.0f);
	for(int i=1;i<numRigidBodies;i++) {
		pfxApplyExternalForce(states[i],bodies[i],bodies[i].getMass()*gravityAcceleration,PfxVector3(0.0f),timeStep);
		//pfxApplyExternalForce(states[i],bodies[i],bodies[i].getMass()*PfxVector3(0.0f,-0.09f,0.0f),PfxVector3(0.0f),timeStep);
	}
...
void createScenePrimitives()
{
	...
	// convex mesh
	{
		...
		states[id].setOrientation(PfxQuat::rotationX(0.5f)*PfxQuat::rotationY(0.1f));
...
/*
	...
	ang+=.1f;
	SCE_PFX_PRINTF("ang=%f\n",ang);
	createBrick(numRigidBodies++,PfxVector3(0,0,0),
		PfxQuat::rotationX(0.5f)*PfxQuat::rotationY(ang),
		PfxVector3(1),1);
//			states[id].setOrientation(PfxQuat::rotationX(0.5f)*PfxQuat::rotationY(0.1f));
*/
}
...
//	states[id].setPosition(PfxVector3(0.0f,-12.5f,0.0f));
//	states[id].setOrientation(PfxQuat::rotationX(-0.5f)*PfxQuat::rotationY(-0.1f));
